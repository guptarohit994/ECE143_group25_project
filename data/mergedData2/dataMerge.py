...
def merge(data1, set2, filename):
    ...
    for n in range(len(l2)):
        ...
        if flag:
            ...
            C3.append(p3)
            C4.append(t)
        #             data2.loc[idx].GrossPay = payment
        #             data2.loc[idx].NAME = name2
...
csvList = ['ANTH', 'BENG', 'BIOL', 'CAT', 'CENG', 'CGS', 'CHEM', 'CHIN', 'COGS', 'COMM', 'CONT', 'CSE', 'DOC', 'ECON', 'ECE', 'EDS', 'ENVR', 'ERC', 'ESYS', 'ETHN', 'FILM', 'FPMU', 'HDP', 'HIST', 'HMNR', 'HUM', 'ICAM', 'INTL', 'JAPN', 'JUDA', 'LATI', 'LAWS', 'LING', 'LIT', 'MAE', 'MATH', 'MMW', 'MUIR', 'MUS', 'NENG', 'PHIL', 'PHYS', 'POLI', 'PSYC', 'RELI', 'REV', 'RSM', 'SDCC', 'SE', 'SIO', 'SOC', 'SOE', 'STPA', 'SXTH', 'THEA', 'TMC', 'TWS', 'USP', 'VIS', 'WARR', 'WCWP']
