            ...
            var sortkeys = ["shiftKey", "altKey", "ctrlKey"],
                ...
                formatCol = function (pos, rowInd) {
                    var ral = ts.p.colModel[pos].align,
                        result = 'style="',
                        clas = ts.p.colModel[pos].classes;
                    if (ral) {
                ...
                addXmlData = function (xml, t, rcnt, more, adjust) {
                    ...
                    var gxml = $(ts.p.xmlReader.root + " " + ts.p.xmlReader.row, xml),
                        ...
                        j = 0;
                    if (gxml && gl) {
                            var rn = parseInt(ts.p.rowNum),
                                br = ts.p.scroll ? (parseInt(ts.p.page) - 1) * rn + 1 : 1;
                            if (adjust) {
                                    rn *= adjust + 1
                                }
                ...
                sortArrayData = function () {
                    ...
                    var rows = [],
                        col = 0,
                        st, sv, findSortKey, newDir = (ts.p.sortorder == "asc") ? 1 : -1;
...
(function (c) {
    ...
    c.fmatter.util = {
        ...
        DateFormat: function (I, L, O, x) {
            var m = /\\.|[dDjlNSwzWFmMntLoYyaABgGhHisueIOPTZcrU]/g,
            ...
            var t = g.getHours(),
                ...
                F = g.getDate(),
                B = g.getMonth() + 1,
                A = g.getTimezoneOffset(),
                y = g.getSeconds(),
                v = g.getMilliseconds(),
                r = g.getDay(),
                e = g.getFullYear(),
                l = (r + 6) % 7 + 1,
                p = (new Date(e, B - 1, F) - new Date(e, 0, 1)) / 86400000,
                h = {
                    d: J(F),
                    D: D.i18n.dayNames[r],
                    j: F,
    ...
    c.fn.fmatter.select = function (k, d, e, n) {
        ...
        if (g) {
                var q = d.colModel.editoptions.multiple === true ? true : false,
                    p = [],
                    o;
                if (q) {
                        p = k.split(",");
    ...
    c.unformat = function (g, n, k, e) {
        var j, h = n.colModel.formatter,
            i = n.colModel.formatoptions || {},
            o, m = /([\.\*\_\'\(\)\{\}\+\?\\])/g;
    ...
    a.jgrid.extend({
        ...
        filterToolbar: function (b) {
            ...
            return this.each(function () {
                ...
                var h = a("<tr class='ui-search-toolbar' role='rowheader'></tr>"),
                    d, i, e;
                var k;
...
function info_dialog(n, h, b, m) {
    ...
    var j = isNaN(k.dataheight) ? k.dataheight : k.dataheight + "px",
        l = "text-align:" + k.align + ";";
    ...
    b.jgrid.extend({
            ...
            return this.each(function () {
                ...
                if (b.fn.searchFilter) {
                    ...
                    if (b("#" + g).html() != null) {
                        ...
                        var n = [],
                            v = b("#" + l.p.id).jqGrid("getGridParam", "colNames"),
                            s = b("#" + l.p.id).jqGrid("getGridParam", "colModel"),
                            u = ["eq", "ne", "lt", "le", "gt", "ge", "bw", "bn", "in", "ni", "ew", "en", "cn", "nc"],
                            i, r, h, p;
                        ...
                        b.each(s, function (w, j) {
                                q = (typeof j.search === "undefined") ? true : j.search,
        ...
        editGridRow: function (c, d) {
            ...
            return this.each(function () {
                ...
                var C = e.p.id,
                    ...
                    D = b.isFunction(a.beforeShowForm) ? a.beforeShowForm : false,
                    O = b.isFunction(a.afterShowForm) ? a.afterShowForm : false,
                    N = b.isFunction(a.beforeInitData) ? a.beforeInitData : false,
                    o = b.isFunction(a.onInitializeForm) ? a.onInitializeForm : false,
                    I = null,
                    J = 1,
                    q = 0,
                    v, E, F, R, H, B;
                ...
                if (b("#" + i.themodal).html() != null) {
                        ...
                        var M, U = b("<form name='FormPost' id='" + y + "' class='FormGrid' style='width:100%;overflow:auto;position:relative;height:" + r + ";'></form>").data("disabled", false),
                            A = b("<table id='" + u + "' class='EditTable' cellspacing='0' cellpading='0' border='0'><tbody></tbody></table>");
                        b(U).append(A);
                        ...
                        var f = e.p.direction == "rtl" ? true : false,
                            ...
                            V = f ? "pData" : "nData",
                            z = s(c, e, A, J),
                            l = "<a href='javascript:void(0)' id='" + T + "' class='fm-button ui-state-default ui-corner-left'><span class='ui-icon ui-icon-triangle-1-w'></span></div>",
                            m = "<a href='javascript:void(0)' id='" + V + "' class='fm-button ui-state-default ui-corner-right'><span class='ui-icon ui-icon-triangle-1-e'></span></div>",
                            h = "<a href='javascript:void(0)' id='sData' class='fm-button ui-state-default ui-corner-all'>" + d.bSubmit + "</a>",
                            t = "<a href='javascript:void(0)' id='cData' class='fm-button ui-state-default ui-corner-all'>" + d.bCancel + "</a>";
                ...
                function s(ab, ah, ae, am) {
                        var Y, Z, aj, ak = 0,
                            ao, ap, ai, an = [],
                            af = false,
                            ag, aa, ac = "<td class='CaptionTD ui-widget-content'>&#160;</td><td class='DataTD ui-widget-content' style='white-space:pre'>&#160;</td>",
                            ad = "";
                        ...
                        b(ah.p.colModel).each(function (au) {
                                ...
                                if (Y !== "cb" && Y !== "subgrid" && this.editable === true && Y !== "rn") {
                                    ...
                                    ag = parseInt(frmopt.rowpos) || ak + 1,
        ...
        viewGridRow: function (c, d) {
            ...
            return this.each(function () {
                ...
                if (b("#" + j.themodal).html() != null) {
                        ...
                        var w, C = b("<form name='FormPost' id='" + A + "' class='FormGrid' style='width:100%;overflow:auto;position:relative;height:" + y + ";'></form>"),
                            l = b("<table id='" + s + "' class='EditTable' cellspacing='1' cellpading='2' border='0' style='table-layout:fixed'><tbody></tbody></table>");
                        b(C).append(l);
                        var v = n(c, x, l, h),
                            z = x.p.direction == "rtl" ? true : false,
                            E = z ? "nData" : "pData",
                            g = z ? "pData" : "nData",
                            t = "<a href='javascript:void(0)' id='" + E + "' class='fm-button ui-state-default ui-corner-left'><span class='ui-icon ui-icon-triangle-1-w'></span></div>",
                            u = "<a href='javascript:void(0)' id='" + g + "' class='fm-button ui-state-default ui-corner-right'><span class='ui-icon ui-icon-triangle-1-e'></span></div>",
                ...
                function n(L, R, P, X) {
                        var H, K, S, ab, F, V = 0,
                            ...
                            O = "",
                            I = "<td class='CaptionTD form-view-label ui-widget-content'>&#160;</td><td class='DataTD form-view-data ui-widget-content'>&#160;</td>",
                            M = ["integer", "number", "currency"],
                            U = 0,
                            T = 0,
                            J, G, Y;
                        for (var W = 1; W <= X; W++) {
                        ...
                        b(R.p.colModel).each(function (af) {
                                ...
                                if (H !== "cb" && H !== "subgrid" && H !== "rn" && Y) {
                                    ...
                                    var ae = b.extend({}, this.editoptions || {}, {
                                        ...
                                        ag = parseInt(aj.rowpos) || V + 1,
                                        ai = parseInt((parseInt(aj.colpos) || 1) * 2);
                                    if (aj.rowabove) {
        ...
        delGridRow: function (c, d) {
            ...
            return this.each(function () {
                ...
                var m = typeof d.beforeShowForm === "function" ? true : false,
                    g = typeof d.afterShowForm === "function" ? true : false,
                    e = l.p.id,
                    f = {},
                    j = "DelTbl_" + e,
                    h = {
                ...
                if (b("#" + h.themodal).html() != null) {
                        ...
                        k += "</tbody></table></div>";
                        var i = "<a href='javascript:void(0)' id='dData' class='fm-button ui-state-default ui-corner-all'>" + d.bSubmit + "</a>",
                            o = "<a href='javascript:void(0)' id='eData' class='fm-button ui-state-default ui-corner-all'>" + d.bCancel + "</a>";
        ...
        navGrid: function (f, h, e, g, d, c, i) {
            ...
            return this.each(function () {
                ...
                var p, q = b("<table cellspacing='0' cellpadding='0' border='0' class='ui-pg-table navtable' style='float:left;table-layout:auto;'><tbody><tr></tr></tbody></table>"),
                    r = "<td class='ui-pg-button ui-state-disabled' style='width:4px;'><span class='ui-separator'></span></td>",
                    l = b(n.p.pager).attr("id") || "pager";
    ...
    a.jgrid.extend({
        ...
        saveCell: function (c, b) {
            return this.each(function () {
                ...
                if (m != null) {
                        var h = a("td:eq(" + b + ")", k.rows[c]),
                            s, p, r = k.p.colModel[b],
                            t = r.name,
                            g = a.jgrid.jqID(t);
                        switch (r.edittype) {
                            case "select":
        ...
        GridNav: function () {
            return this.each(function () {
                ...
                g.p.knv = g.p.id + "_kn";
                var f = a("<span style='width:0px;height:0px;background-color:black;' tabindex='0'><span tabindex='-1' style='width:0px;height:0px;background-color:grey' id='" + g.p.knv + "'></span></span>"),
                    d, c;
...
(function (d) {
    ...
    var n = 0,
        ...
        b = function (o) {
            var f = k[a[a.length - 1]],
                m = (!d(o.target).parents(".jqmID" + f.s)[0]);
            if (m) {
                    g(f)
                }
            return !m
    ...
    a.jgrid.extend({
        ...
        addSubGrid: function (b, c) {
            return this.each(function () {
                ...
                var d = function (v, t) {
                    var x, u, w, q, s = a("<table cellspacing='0' cellpadding='0' border='0'><tbody></tbody></table>"),
                        r = a("<tr></tr>");
                ...
                var f = function (x, u) {
                    var z, B, v, y, q, s = a("<table cellspacing='0' cellpadding='0' border='0'><tbody></tbody></table>"),
                        r = a("<tr></tr>");
    ...
    a.jgrid.extend({
        ...
        getNodeParent: function (c) {
            ...
            this.each(function () {
                ...
                case "nested":
                    var e = parseInt(c.lft, 10),
                        d = parseInt(c.rgt, 10),
                        f = parseInt(c.level, 10);
        ...
        setColumns: function (b) {
            ...
            return this.each(function () {
                ...
                if (a("#" + f.themodal).html() != null) {
                        ...
                        m += "</tbody></table></div>";
                        var g = !b.updateAfterCheck ? "<a href='javascript:void(0)' id='dData' class='fm-button ui-state-default ui-corner-all'>" + b.bSubmit + "</a>" : "",
                            n = "<a href='javascript:void(0)' id='eData' class='fm-button ui-state-default ui-corner-all'>" + b.bCancel + "</a>";
